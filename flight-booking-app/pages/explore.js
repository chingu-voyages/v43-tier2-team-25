...
const Explore = () => {
  ...
  return (
    <div className='lg:mt-10 lg:px-[13.25rem] md:px-[3.125rem] px-5 overflow-x-hidden' onLoad={getDate}>
      ...
      <div className='relative lg:mb-[22rem] md:pb-56 pb-[9.625rem] lg:pb-0'>
        <h2 className='text-center lg:text-5xl lg:leading-[4rem] md:text-4xl md:mt-14 mt-8 text-2xl font-bold text-grayishDark'>
      ...
      <div className='lg:mb-28 md:mb-16 mb-12'>
        <div className='flex items-center gap-2 mb-7'>
          ...
          <h3 className='lg:text-2xl md:text-xl font-semibold text-grayText'>Flights</h3>
        </div>

        <form action="" className="flex flex-col md:flex-row lg:gap-16 md:gap-7 gap-4 lg:py-14 lg:px-8 md:py-7 md:px-5 p-5 rounded-2xl md:-mx-9 lg:mx-0">
      ...
      <div>
        ...
        <div className='flex gap-5'>
          <div className={`flex items-center gap-2 ${section === 'flights' ? 'bg-white' : ''} md:rounded-t-2xl rounded-t-md md:p-3 p-1 cursor-pointer`}
          ...
          <div className={`flex items-center gap-2 ${section === 'hotels' ? 'bg-white' : ''} md:rounded-t-2xl rounded-t-md md:p-3 p-1 cursor-pointer`}
            onClick={() => {
              setSection('hotels');
              setType('hotels')
            }}
          ...
          {section === 'flights' ?
            city && travelDate && checkOut && destination ?
              flights.length ?
                ...
                <div>
                  <h1 className='text-center text-base text-grayText md:text-xl'>Fill the field to get available flights!</h1>
                </div>
              )
